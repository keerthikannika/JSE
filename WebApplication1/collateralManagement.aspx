<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="collateralManagement.aspx.cs" Inherits="WebApplication1.collateralManagement" %>
                                    ...
                                    <div class="w-grid-list">
                                        <article class="w-grid-item size_1x1 post-88 post type-post status-publish format-standard has-post-thumbnail hentry category-news" data-id="88">
                                            <div class="w-grid-item-h">
                                                ...
                                                <div class="w-post-elm post_image usg_post_image_1 stretched">
                                                    <a href="/newsConference.aspx" aria-label="WFEClear: The WFE’s Clearing and Derivatives Conference 2023">
                                        ...
                                        <article class="w-grid-item size_1x1 post-64 post type-post status-publish format-standard has-post-thumbnail hentry category-news" data-id="64">
                                            <div class="w-grid-item-h">
                                                ...
                                                <div class="w-post-elm post_image usg_post_image_1 stretched">
                                                    <a href="/newsCounterparty.aspx" aria-label="JSE Clear granted Independent Clearing House &#038; Central Counterparty licence">
