<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="membership.aspx.cs" Inherits="WebApplication1.Membership" %>
                                ...
                                <div class="w-grid type_grid layout_76 cols_3 ratio_custom" id="us_grid_2" data-filterable="true">
                                    ...
                                    <div class="w-grid-list">
                                        ...
                                        <article class="w-grid-item size_1x1 post-64 post type-post status-publish format-standard has-post-thumbnail hentry category-news" data-id="64">
                                            <div class="w-grid-item-h">
                                                <a class="w-grid-item-anchor" href="/newsCounterpary.aspx" rel="bookmark" aria-label="JSE Clear granted Independent Clearing House &#038; Central Counterparty licence"></a>
                                                <div class="w-post-elm post_image usg_post_image_1 stretched"><a href="/newsCounterpary.aspx" aria-label="JSE Clear granted Independent Clearing House &#038; Central Counterparty licence">
                                                ...
                                                <div class="w-vwrapper usg_vwrapper_1 align_none valign_top">
                                                    ...
                                                    <h2 class="w-post-elm post_title usg_post_title_1 entry-title color_link_inherit"><a href="/newsCounterpary.aspx">JSE Clear granted Independent Clearing House &#038; Central Counterparty licence</a></h2>
                                                </div>
                                            </div>
                                        </article>
                                    </div>
